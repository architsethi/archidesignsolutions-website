                  ...
                  <div className={styles.infoBlock}>
                    ...
                    <div className={styles.socialButtons}>
                      ...
                      {contact.socials?.whatsapp && (
                        <a href={contact.socials.whatsapp} target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>
                      ...
                      {contact.socials?.facebook && (
                        <a href={contact.socials.facebook} target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>
