...
export const defaultSiteData: SiteData = {
  ...
  homeServiceImages: [
    ...
    { title: "Architectural Branding", img: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&q=80" },
    { title: "Project Management", img: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=600&q=80" },
  ],
  contactSubmissions: [],
};
